...
from utils.constants import llm_model_path, FILE_INDEX_PATH, FAISS_DIR, META_PATH, INDEX_PATH
...
def init_rag_tool():
    ...
    if rag_tool is None:
        rag_tool = SentenceTransformer(
            r"C:\Users\shuei\Desktop\Offline_AI_Knowledge_Base\paraphrase-MiniLM",
            device="cpu",
            cache_folder="./cache"
        )
